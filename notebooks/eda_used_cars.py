...
plt.ylabel("Count")
plt.tight_layout()
plt.savefig(r"C:\Users\Pranav\OneDrive\Desktop\Project\plots\price_distribution.png", dpi=200, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Pranav\OneDrive\Desktop\Project\plots\price_by_fuel.png", dpi=200, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Pranav\OneDrive\Desktop\Project\plots\price_vs_kms.png", dpi=200, bbox_inches="tight")
plt.show()
...
plt.ylabel("Price (in lakhs)")
plt.tight_layout()
plt.savefig(r"C:\Users\Pranav\OneDrive\Desktop\Project\plots\price_vs_age.png", dpi=200, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Pranav\OneDrive\Desktop\Project\plots\Top 10 Cars_Average_Price.png", dpi=200, bbox_inches="tight")
plt.show()
